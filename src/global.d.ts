    ...
    interface Window {
        api?: {
            ...
            bindings: {
                ...
                upsert: (payload: { id?: number; code: string; name: string; description?: string | null; startDate?: string | null; endDate?: string | null; isActive?: boolean; color?: string | null; budget?: number | null; enforceTimeRange?: boolean }) => Promise<{ id: number }>
                delete: (payload: { id: number }) => Promise<{ id: number }>
            ...
            invoices: {
                ...
                markPaid: (payload: any) => Promise<any>
                postToVoucher: (payload: any) => Promise<any>
            }
            cashChecks: {
