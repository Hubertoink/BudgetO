            ...
            <div className="members-header-top">
                <div className="members-header-left">
                    ...
                    <ColumnSelectDropdown
                        columns={[
                            { key: 'showMemberNo', label: 'Nr. anzeigen', checked: colPrefs.showMemberNo, onChange: (v) => setColPrefs(p => ({ ...p, showMemberNo: v })) },
                            { key: 'showIBAN', label: 'IBAN anzeigen', checked: colPrefs.showIBAN, onChange: (v) => setColPrefs(p => ({ ...p, showIBAN: v })) },
                            { key: 'showContribution', label: 'Beitrag anzeigen', checked: colPrefs.showContribution, onChange: (v) => setColPrefs(p => ({ ...p, showContribution: v })) },
                            { key: 'showAddress', label: 'Adresse anzeigen', checked: colPrefs.showAddress, onChange: (v) => setColPrefs(p => ({ ...p, showAddress: v })) },
                            { key: 'showNotes', label: 'Anmerkungen anzeigen', checked: colPrefs.showNotes, onChange: (v) => setColPrefs(p => ({ ...p, showNotes: v })) },
                        ]}
